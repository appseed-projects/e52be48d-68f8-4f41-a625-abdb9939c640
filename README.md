...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-07-02 19:56`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e52be48d-68f8-4f41-a625-abdb9939c640.git
$ cd e52be48d-68f8-4f41-a625-abdb9939c640
```
